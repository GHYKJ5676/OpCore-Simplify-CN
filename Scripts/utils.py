...
class Utils:
    ...
    def request_input(self, prompt="按 Enter 继续..."):
    ...
    def exit_program(self):
        ...
        width = 68
        print("")
        print("如需更多信息、报告错误或为产品做贡献：".center(width))
        print("")
        separator = "─" * (width - 4)
        print(f" ┌{separator}┐ ")
        contacts = {
            ...
            "CN GitHub": "https://github.com/GHY5676/OpCore-Simplify",
        ...
        print(f" └{separator}┘ ")
        print("")
        print("感谢您使用我们的程序！".center(width))
        print("")
        self.request_input("按 Enter 退出。".center(width))
        sys.exit(0)